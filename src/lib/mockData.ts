...
export const rhymeData: Record<string, RhymeGroup> = {
  ...
  love: {
    perfect: ["above", "dove", "glove", "shove", "of", "thereof"],
    near: ["move", "groove", "prove", "remove", "smooth", "soothe"],
    multi: [
      "fall in love",
      "push and shove",
      "fit like a glove",
    ...
    slant: ["live", "give", "lift", "drift", "shift", "swift", "gift"],
  },
  night: {
    perfect: ["sight", "light", "right", "might", "fight", "tight", "bright", "flight", "write"],
    near: ["white", "quite", "bite", "life", "knife", "wide", "side"],
    multi: [
      "dead of night",
      "city lights",
      "burning bright",
    ...
    slant: ["time", "mine", "shine", "fine", "wine", "vine", "find", "mind", "blind"],
  },
  pain: {
    perfect: ["rain", "vain", "main", "chain", "plain", "gain", "train", "remain", "contain", "insane"],
    near: ["blame", "flame", "same", "name", "game", "came", "shame", "claim"],
    multi: [
      "fall like rain",
      "drive me insane",
      "break the chain",
    ...
    slant: ["find", "mind", "blind", "kind", "bind", "lined", "resigned"],
  },
  desire: {
    perfect: ["fire", "higher", "wire", "inspire", "require", "entire"],
    near: ["liar", "buyer", "flyer", "prior", "choir"],
    multi: [
      "hearts on fire",
      "burning desire",
      "rise higher",
    ...
    slant: ["shine", "divine", "design", "decline", "refine", "wine", "mine"],
  },
  heart: {
    perfect: ["start", "art", "part", "apart", "smart", "dart", "chart", "impart"],
    near: ["hard", "guard", "star", "far", "scar", "bar", "jar", "guard"],
    multi: [
      "fall apart",
      "from the start",
      "break my heart",
    ...
    slant: ["dark", "park", "spark", "mark", "stark", "hark", "bark"],
  },
  soul: {
    perfect: ["whole", "role", "goal", "hole", "toll", "roll", "pole", "stole", "control"],
    near: ["cold", "bold", "told", "hold", "gold", "old", "fold", "mold"],
    multi: [
      "take control",
      "rock and roll",
      "heart and soul",
    ...
    slant: ["go", "know", "flow", "show", "glow", "grow", "below", "bestow"],
  },
  danger: {
    perfect: ["stranger", "manger", "ranger"],
    near: ["anger", "linger", "singer", "finger", "wonder", "tender"],
    multi: [
      "stranger danger",
      "face the danger",
      "out of danger",
    ...
    slant: ["change", "strange", "range", "arrange", "exchange", "remain", "sustain"],
  },
};
